...
cy# evan.getFolderDetails()
// if no folder is open
// => 'A folder must be open'

// if a folder is open
// => '{topIconInset:26,bottomIconInset:8,sideIconInset:26,iconRowsForSpacingCalculation:3,iconColumnsForCurrentOrientation:3,verticalIconPadding:16,horizontalIconPadding:36,iconsInRowForSpacingCalculation:3,iconLocation:5}'
```
